...
%% ============================================================
%% Absolute figures and tables can appear anywhere in the source.
%% If a float targets an earlier page than where it appears, rerun
%% LaTeX so the placement cache can be replayed.
%% ============================================================
...
Figure~\ref{fig:latep2} on page~\pageref{fig:latep2},
...
%% ============================================================
%% Late-defined earlier-page test: this appears near the end of the
%% source but targets page 2, so it requires a rerun to settle.
%% ============================================================

\begin{absfigure}[page=2, pos=t, col=2]
  \centering
  \rule{0.9\columnwidth}{1.6cm}
  \caption{Late-defined figure replayed onto page~2 after rerun}
  \label{fig:latep2}
\end{absfigure}
